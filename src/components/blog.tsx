...
import post1 from "@/images/f1.png";
import post3 from "@/images/f3.jpg";
import post2 from "@/images/f2.jpg";
...
export default function Blog() {
  ...
  return (
    <div className="bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 absolute mt-[950] ">
      {/* Header  */}
      <div className="text-center mb-12">
        <p className="text-blue-700 text-sm font-semibold uppercase">
          Practice Advice
        </p>
